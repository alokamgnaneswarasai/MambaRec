...
./run_exp.sh --dataset=ml-1m --train_dir=tracks256_default/ --maxlen=256 --batch_size=32 --backbone=localsas --hidden_units=128 --eval_neg_sample=100  --device=cuda:0 --num_epochs=500
