...
./run_exp.sh --dataset=ml-1m  --train_dir=tracks256_default/ --maxlen=200  --batch_size=16 --backbone=hourglass --hidden_units=64 --eval_neg_sample=100  --device=cuda:3 --num_epochs=500
