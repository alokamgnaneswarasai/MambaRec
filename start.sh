...
./run_exp.sh --dataset=tracks256 --train_dir=tracks256_default/ --maxlen=200  --batch_size=16 --backbone=transformerxl --hidden_units=32 --eval_neg_sample=100  --device=cuda:5 --num_epochs=500
