...
./run_exp.sh --dataset=KuaiRand5000 --train_dir=tracks256_default/ --maxlen=1024 --batch_size=32 --backbone=queryusernoiselocalmamba --hidden_units=32 --eval_neg_sample=100  --device=cuda:6 --num_epochs=500
