...
output_file="${output_dir}/${dataset}_${backbone}_hidden=${hidden_units}_batch=${batch_size}_maxlen=${maxlen}_neg=${eval_neg_sample}_device=$(echo $device | tr ':' '_')_num_epochs=${num_epochs}_new_model.out"
